...
def app():
    if 'username' in st.session_state:
        ...
        if st.session_state.current_view == 'detalleAgrupacion':
            if st.session_state.useremail is not None:
                EventName,EventAction,EventUser='agrupacion','acceso a las vista detalleAgrupacion',st.session_state.useremail
        ...
        if st.session_state.current_view == 'finalProcesoAgrupacion':
                EventName,EventAction,EventUser='agrupacion','finalProcesoAgrupacion detalleAgrupacion',st.session_state.useremail
                event_instert(EventName,EventAction,EventUser, st.session_state.orderId)
