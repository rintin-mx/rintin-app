        ...
        if 'username' in st.session_state:
                ...
                if st.session_state.current_view == 'detalleConfirmacion':
                      if st.session_state.useremail is not None:
                        ...
                        event_instert(EventName,EventAction,EventUser, int(st.session_state['Order_id_confirmacion']))  
                ...
                if st.session_state.current_view == 'finalProcesoConfirmacion':
                    EventName,EventAction,EventUser='confirmacion','finalProcesoConfirmacion detalleConfirmacion',st.session_state.useremail
                    event_instert(EventName,EventAction,EventUser, int(st.session_state['Order_id_confirmacion']))  
