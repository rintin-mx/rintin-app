        ...
        if 'username' in st.session_state:
                ...
                if st.session_state.current_view == 'pick':
                    ...
                    if st.session_state.useremail is not None:
                        ...
                        event_instert(EventName,EventAction,EventUser, str(st.session_state.orderId))
                    ...
                    if st.session_state.useremail is not None:
                        EventName,EventAction,EventUser='picking','pickFinal',st.session_state.useremail
                        event_instert(EventName,EventAction,EventUser, st.session_state['currentOrderId'])
