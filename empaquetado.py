...
def app():
    if 'username' in st.session_state:
        ...
        if st.session_state.current_view == 'detalleEmpaquetado':
            if st.session_state.useremail is not None:
                EventName,EventAction,EventUser='empaquetado','acceso a las vista detalleEmpaquetado',st.session_state.useremail
                event_instert(EventName,EventAction,EventUser,st.session_state.orderId)
        ...
        if st.session_state.current_view == 'finalProcesoEmpaquetado':
                EventName,EventAction,EventUser='empaquetado','finalProcesoEmpaquetado detalleEmpaquetado',st.session_state.useremail
                event_instert(EventName,EventAction,EventUser,st.session_state.orderId)
