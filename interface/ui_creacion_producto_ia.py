    ...
    prompt_messages=[
        {
            ...
            "content": [
                ...
                "text": """
                    ...
                    Categoria_hijo: (Dependiendo de la eleccion en Categoria_padre, 
                    si escogiste Hombre: Calzado, Bolsas Mochilas y Carteras, Ropa; 
                    Mujer: Calzado, Ropa, Bolsas Mochilas y Carteras, Maquillaje; 
                    niño/niña: Bolsas Mochilas y Carteras, Calzado, Ropa; 
                    Productos Varios: Escolar/Profesional, Accesorios, Papeleria, Paraguas; 
                    unisex: Bolsas Mochilas y Carteras, Gorras Viceras y Sombreros, Accesorios; 
                    Duos: Ropa. 

                    Si no hay una categoría que se ajuste dentro de las opciones en la eleccion de categoria_padre, dejar en blanco).

                    Subcategoria_1: (Dependiendo de la eleccion en Categoria_hijo, si escogiste 
                    Accesorio: Mangas; Bolsas, Mochilas y Carteras: Cangurera, Carteras, Mariconeras, Bolsas, Mochilas, Lonchera, Lapicera; 
                    Calzado: Botas y Botines, Pantuflas, Sandalias, Tenis, Alpargatas, Flats / Valerinas;
                    Ropa: Bermudas, Blusas, Bufanda, Calcentines y Calceteria, Camisas, Camison, Chalecos, Chamarras, Conjuntos, Faldas, Gorras Viseras y Sombreros, Impermeables, Jeans, Joggers, Jumpsuit, Leggings, Lenceria, Mangas, Palazzo, Pantalones, Pants, Pijamas, Playeras, Ponchos Capas y Batas, Ropa de Maternidad, Ropa Deportiva, Ropa Escolar, Ropa Interior, Sacos, Shorts, Sudaderas, Sueteres, Tallas Extra, Trajes de Baño, Vestidos y Palazzos, Vestidos, Abrigos. 

                    Si no hay una categoría que se ajuste dentro de las opciones en la eleccion de categoria_hijo, dejar en blanco).

                    Subcategoria_2: (Dependiendo de la eleccion en Subcategoria_1, si escogiste 
                    Blusas: Body, Corset, Crop Top, Tops, Bluson; 
                    Calcentines y Calceteria: Calceta, Calcetines Altos, Calcetines Cortos, Calcetines Medios, Calcetines Tobillo, Medias, Protectores; 
                    Jeans: Short, Chaleco Mezclilla, Corte Colombiano, Corte Mom, Talla Extra, Overol, Corte Acampanado, Vestidos Cortos, Faldas, Chamarra Mezclilla, Corte Skinny, Corte Slim Fit, Corte Extra Skinny, Corte Regular Fit, Cargo, Corte Recto; 
                    Pantalones: Cargo, Acampanado; 
                    Ropa Deportiva: Licras, Tops, Conjunto, Short; 
                    Vestidos: Vestidos Cortos, Vestidos Largos; 
                    Ropa Interior: Bikini, Boxers, Brasier, Cachetero, Conjuntos, Faja, Pantaletas, Tanga, Top, Top Niña, Trusa. 

                    Si no hay una categoría que se ajuste dentro de las opciones en la eleccion de subcategoria_1, dejar en blanco).

                    Subcategoria_3: (Dependiendo de la eleccion en Subcategoria_2, 
                    si escogiste Bikini: Algodon, Microfibra, Sin Costura, Encaje; 
                    Boxers: Algodon, Microfibra, Sin Costura, Encaje; 
                    Cachetero: Sin Costura, Encaje; 
                    Pantaletas: Algodon, Microfibra, Sin Costura, Encaje; 
                    Tanga: Algodon, Microfibra, Sin Costura, Encaje; 
                    Top: Algodon, Microfibra, Sin Costura, Encaje; 
                    Trusa: Algodon, Microfibra. 

                    Si no hay una categoría que se ajuste dentro de las opciones en la eleccion de subcategoria_2, dejar en blanco)
